...
const FeatureCard = ({ icon: Icon, title, desc, delay, isHighlight = false }: any) => {
  return (
    <motion.div 
    ...
    >
      ...
      {/* Icon Wrapper */}
      <div className={`w-14 h-14 rounded-xl flex items-center justify-center mb-6 text-xl transition-colors duration-300
      ...
      <h3 className="text-xl font-bold mb-3 text-white group-hover:text-avisena-400 transition-colors duration-300">{title}</h3>
      <p className="text-slate-400 text-sm leading-relaxed mb-4">{desc}</p>
      
      {isHighlight && (
        <a href="#" className="inline-flex items-center text-avisena-400 text-sm font-semibold hover:text-white transition-colors duration-300 gap-2 mt-2">
...
export default function Home() {
  ...
  return (
    <main className="relative bg-slate-50 overflow-x-hidden">
        ...
        <div className="container mx-auto px-6 flex justify-between items-center">
            ...
            <div className="hidden md:flex space-x-8 text-sm font-semibold text-slate-300">
                {['Our Dream', 'Network', 'Investors', 'Contact'].map((item) => (
                  <a key={item} href={`#${item.toLowerCase().replace(' ', '')}`} className="hover:text-white transition relative group">
                    {item}
      ...
      >
        {/* Parallax Background Effect via fixed layout */}
        <div 
          className="absolute inset-0 z-0"
          style={{
            backgroundImage: `linear-gradient(rgba(12, 74, 110, 0.85), rgba(2, 6, 23, 0.9)), url('https://images.unsplash.com/photo-1516549655169-df83a0774514?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80')`,
            backgroundSize: 'cover',
            backgroundPosition: 'center',
            backgroundAttachment: 'fixed' // Create parallax feeling
          }}
        />
        ...
        <div className="text-center max-w-5xl mx-auto z-10">
            ...
            >
                Driven by a dream to elevate public health standards across the province. 
                We are building a centralized digital gateway for Avisena Hospitals—serving the people of West Java with compassion and modern innovation.
            </motion.p>
            ...
            >
                <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-2">
                    ...
                    />
                    <button type="submit" className="bg-avisena-500 hover:bg-avisena-600 text-white px-6 py-3 rounded-lg font-semibold transition-all shadow-[0_0_20px_rgba(14,165,233,0.4)] hover:shadow-[0_0_30px_rgba(14,165,233,0.6)] whitespace-nowrap">
                        Join Our Journey
                    </button>
                </form>
            </motion.div>
        ...
        >
            <a href="#about" className="text-white/50 hover:text-white transition flex flex-col items-center gap-2 pointer-events-auto animate-bounce">
                <span className="text-[10px] tracking-[0.2em] uppercase">Our Mission</span>
        ...
        <div className="container mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-16 items-center">
                ...
                >
                    ...
                    >
                        <p className="text-slate-600 italic text-sm mb-2">"Our goal is not just to build hospitals, but to build a healthier generation for West Java."</p>
                        <span className="text-xs font-bold text-avisena-800 tracking-wider uppercase">- Management</span>
                    </motion.div>
                </motion.div>
                ...
                >
                    <h2 className="text-sm font-bold text-avisena-600 uppercase tracking-widest mb-2">Regional Commitment</h2>
                    <h3 className="text-3xl md:text-5xl font-serif font-bold text-slate-900 mb-6 leading-tight">Empowering Communities Through Better Care</h3>
                    <p className="text-slate-600 mb-6 leading-relaxed text-lg">
                        Avisena Hospitals was founded on a strong conviction: that every citizen in West Java deserves access to quality, dignified, and modern healthcare. 
                    </p>
                    <p className="text-slate-600 mb-8 leading-relaxed">
                        We are currently integrating our systems to provide a seamless experience across all our branches. This website will soon serve as the central hub for patient services, health literacy, and regional expansion updates.
                    </p>
                    
                    <div className="border-t border-slate-200 pt-8">
                        <div className="flex flex-col sm:flex-row gap-8">
                            <motion.div whileHover={{ scale: 1.05 }} className="cursor-default">
                                <h4 className="text-4xl font-serif font-bold text-avisena-600 mb-1">High</h4>
                                <p className="text-sm font-semibold text-slate-900">Quality Standards</p>
                            </motion.div>
                            <motion.div whileHover={{ scale: 1.05 }} className="cursor-default">
                                <h4 className="text-4xl font-serif font-bold text-avisena-600 mb-1">Local</h4>
      ...
      <section id="invest" className="py-32 bg-slate-950 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
            <div className="text-center mb-16">
                ...
                >
                    Be part of the healthcare transformation in Indonesia&apos;s most populous province.
                </motion.p>
            </div>
      ...
      {/* Footer */}
      <footer id="contact" className="bg-black text-slate-500 py-12 border-t border-slate-900">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
            
            <div className="text-center md:text-left">
                <span className="text-xl font-serif font-bold text-white tracking-wide">AVISENA <span className="text-avisena-600">HOSPITALS</span></span>
                <p className="text-sm mt-2 text-slate-400">Head Office: Bandung, West Java</p>
                <p className="text-xs mt-1 text-slate-600">&copy; {new Date().getFullYear()} PT Avisena Medika. All Rights Reserved.</p>
            </div>

            <div className="flex items-center space-x-6">
                <a href="#" className="group relative text-slate-400 hover:text-white transition duration-300" aria-label="LinkedIn">
                    <FaLinkedin className="text-2xl group-hover:scale-110 transform transition" />
                </a>
                
                <a href="#" className="group relative text-slate-400 hover:text-white transition duration-300" aria-label="Instagram">
